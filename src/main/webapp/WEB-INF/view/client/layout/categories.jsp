        ...
        <section class="popular-categories">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <a href="/products" class="btn btn-outline-warning">View all categories</a>
                </div>
                <div class="categories-grid">
                    <a href="/products?category=PIZZA" class="category-card text-decoration-none" data-category="PIZZA">
                        <img src="/client/img/PizzaAnimation.png" alt="Pizza">
                        <h5>Pizza</h5>
                        <p>${pizzaCount} items</p>
                    </a>
                    <a href="/products?category=BURGER_CHICKEN" class="category-card text-decoration-none"
                        data-category="BURGER_CHICKEN">
                        <img src="https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=200&h=200&fit=crop&auto=format"
                            alt="Burger">
                        <h5>Burger & Chicken</h5>
                        <p>${burgerChickenCount} items</p>
                    </a>
                    <a href="/products?category=NOODLE" class="category-card text-decoration-none"
                        data-category="NOODLE">
                        <img src="https://images.unsplash.com/photo-1555126634-323283e090fa?w=200&h=200&fit=crop&auto=format"
                            alt="Noodles">
                        <h5>Noodles</h5>
                        <p>${noodleCount} items</p>
                    </a>
                    <a href="/products?category=DRINK" class="category-card text-decoration-none" data-category="DRINK">
                        <img src="https://images.unsplash.com/photo-1544145945-f90425340c7e?w=200&h=200&fit=crop&auto=format"
                            alt="Drinks">
                        <h5>Drinks</h5>
                        <p>${drinkCount} items</p>
                    </a>
                    <a href="/products?category=RICE" class="category-card text-decoration-none" data-category="RICE">
