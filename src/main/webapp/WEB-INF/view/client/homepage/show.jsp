        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                                        ...
                                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                            <li class="nav-item">
                                                <a class="d-flex m-2 py-2 bg-light rounded-pill active"
                                                    ...
                                                    <a href="/products" class="btn btn-outline-warning">View all
                                                        dishes</a>
                                                            ...
                                                            <div class="rounded position-relative fruite-item shadow-sm border-0 w-100 d-flex flex-column"
                                                                ...
                                                                <div class="fruite-img position-relative">
                                                                    ...
                                                                    <div class="position-absolute"
                                                                        ...
                                                                        <button
                                                                            class="btn btn-light rounded-circle p-2 shadow-sm border-0 heart-btn"
                                                                ...
                                                                <div
                                                                    class="p-3 bg-white rounded-bottom flex-fill d-flex flex-column">
                                                                    <h5 class="mb-2"
                                                                        style="font-size: 16px; font-weight: 600; line-height: 1.4;">
                                                                        <a href="/product/${product.id}"
                                                                    ...
                                                                    <p class="text-muted mb-2 flex-fill"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- Food Modal -->
                    <div class="modal fade" id="foodModal" tabindex="-1" aria-labelledby="modalFoodName"
                        aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="product-description">
                                                ...
                                                <p id="modalFoodDescription" class="text-muted mb-3"
                                                    style="line-height: 1.6;">
                                                    Dishes are prepared from the freshest ingredients, ensuring quality
                                                    and food safety.
                                                    With exclusive recipes and modern cooking techniques, each dish
                                                    brings distinctive
                                                    flavors and excellent culinary experience for diners.
                                                </p>
                                                <div class="product-features">
                                                    <small class="text-muted d-block mb-1"><i
                                                            class="fas fa-check-circle text-success me-2"></i>Fresh
                                                        ingredients</small>
                                                    <small class="text-muted d-block mb-1"><i
                                                            class="fas fa-check-circle text-success me-2"></i>Made to
                                                        order</small>
                                                    <small class="text-muted d-block"><i
                                                            class="fas fa-check-circle text-success me-2"></i>Hygienic
                                                        and safe</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="special-notes mb-4">
                                                ...
                                                <div class="notes-options">
                                                    <div class="form-check mb-2">
                                                        ...
                                                        <label class="form-check-label" for="noteSpicy">Less
                                                            sugar</label>
                                                    </div>
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="noteNoOnion">
                                                        <label class="form-check-label" for="noteNoOnion">Extra
                                                            ice</label>
                                                    </div>
                                                    <div class="form-check mb-2">
                                                    ...
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="noteExtraSpice">
                                                        <label class="form-check-label" for="noteExtraSpice">Less
                                                            salt</label>
                                                    </div>
                                                </div>
