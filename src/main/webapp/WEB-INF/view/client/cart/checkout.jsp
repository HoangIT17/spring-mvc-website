                                ...
                                <form:form action="/place-order" method="post" modelAttribute="cart">
                                    ...
                                    <div class="row g-4">
                                            ...
                                            <div class="delivery-info-card bg-white rounded-3 shadow-sm p-4 w-100 d-flex flex-column">
                                                ...
                                                <div class="row g-3 flex-grow-1">
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="receiverName" name="receiverName" required value="${user.fullName}">
                                                    </div>
                                                    <div class="col-12 mb-3">
                                                        <label for="receiverAddress" class="form-label">Address</label>
                                                        <input type="text" class="form-control" id="receiverAddress" name="receiverAddress" required value="${user.address}">
                                                    </div>
                                                    <div class="col-12 mb-3">
                                                        <label for="receiverPhone" class="form-label">Phone number</label>
                                                        <input type="text" class="form-control" id="receiverPhone" name="receiverPhone" required value="${user.phone}">
                                                    </div>

                                                    <div class="col-12">
                                                        <div class="mt-2"><strong>Current location:</strong>
                                                            <span>
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <span>Not set</span>
                                                                        <a href="/profile" class="btn btn-sm btn-outline-warning ms-2">Set location</a>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="col-lg-4 d-flex">
                                            <div
                                                class="order-summary-card bg-white rounded-3 shadow-sm p-4 w-100 d-flex flex-column">
                                                ...
                                                <div class="summary-details flex-grow-1">
                                                    ...
                                                    <hr>
                                                    <div
                                                        class="d-flex justify-content-between fw-bold text-warning fs-5 mb-4">
                                                        <span>Total</span>
                                                        <span>
                                                            <fmt:formatNumber type="number" value="${totalPrice}" /> đ
                                                        </span>
