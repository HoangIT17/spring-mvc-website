                                    ...
                                    <div class="cart-header mb-4">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <button class="btn btn-link text-warning me-3"
                                            ...
                                            <div class="cart-actions">
                                                <span class="badge bg-warning text-dark fs-6">${cartDetails.size()}
                                                    items</span>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <c:choose>
                                                    <c:when test="${empty cartDetails}">
                                                        ...
                                                        <div class="empty-cart-state text-center py-5">
                                                            ...
                                                            <p class="text-muted mb-4">Add your favorite dishes to the
                                                                cart</p>
                                                    ...
                                                    <c:otherwise>
                                                        ...
                                                        <c:forEach var="cartDetail" items="${cartDetails}"
                                                            varStatus="status">
                                                            <div
                                                                class="cart-item-card mb-3 bg-white rounded-3 shadow-sm p-4">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-md-3 col-3">
                                                                        <div
                                                                            class="quantity-controls d-flex justify-content-center">
                                                                            <div class="input-group"
                                                                                style="width: 120px;">
                                                                                <button
                                                                                    class="btn btn-outline-warning btn-minus"
                                                                                    type="button"
                                                                                ...
                                                                                <button
                                                                                    class="btn btn-outline-warning btn-plus"
                                                                                    type="button"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="cart-summary-container">
                                                <c:if test="${not empty cartDetails}">
                                                    <!-- Delivery Info -->
                                                    <div
                                                        class="delivery-info-card mb-4 bg-white rounded-3 shadow-sm p-4">
                                                        <h6 class="fw-bold mb-3">
                                                            <i
                                                                class="fas fa-map-marker-alt text-warning me-2"></i>Delivery
                                                            Information
                                                        </h6>
                                                        <div class="delivery-address">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="delivery-status-dot bg-success rounded-circle me-2"
                                                                        style="width: 8px; height: 8px;"></div>
                                                                    <span class="fw-bold">Standard Delivery</span>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex justify-content-between text-muted">
                                                                <span><i class="fas fa-clock me-1"></i>20-30
                                                                    minutes</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="order-summary-card bg-white rounded-3 shadow-sm p-4">
                                                        <h6 class="fw-bold mb-3">
                                                            <i class="fas fa-receipt text-warning me-2"></i>Order
                                                            Summary
                                                        </h6>
                                                        <div class="summary-details">
                                                            ...
                                                            <hr>
                                                            <div
                                                                class="d-flex justify-content-between fw-bold text-warning fs-5">
                                                                <span>Total</span>
                                                                <span data-cart-total-price="${totalPrice}">
                                                                    <fmt:formatNumber type="number"
                                                                        value="${totalPrice}" /> đ
                                                        ...
                                                        <div class="checkout-actions mt-4">
                                                            <form:form action="/confirm-checkout" method="post"
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    <i class="fas fa-credit-card me-2"></i>Proceed to
                                                                    Checkout
                                                                </button>
                                                            </form:form>
